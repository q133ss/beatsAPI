    ...
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item me-auto"><a class="navbar-brand" href="/html/ltr/vertical-menu-template/index.html"><span class="brand-logo">
                    ...
                    <h2 class="brand-text">Beats</h2>
                </a></li>
            <li class="nav-item nav-toggle">
                <a class="nav-link nav-link-style modern-nav-toggle pe-0"><i class="ficon" data-feather="moon"></i></a>
            </li>
        </ul>
    </div>
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="{{route('category.index')}}">
                    ...
                    <span class="menu-title text-truncate" data-i18n="Email">Категории</span>
                </a>
            </li>

            <li class=" nav-item">
                <a class="d-flex align-items-center" href="{{route('author.index')}}">
                    ...
                    <span class="menu-title text-truncate" data-i18n="Email">Авторы</span>
                </a>
            </li>

            <li class=" nav-item">
                <a class="d-flex align-items-center" href="{{route('beat.index')}}">
                    ...
                    <span class="menu-title text-truncate" data-i18n="Email">Биты</span>
                </a>
            </li>
            ...
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="{{route('user.index')}}">
                    ...
                    <span class="menu-title text-truncate" data-i18n="Email">Пользователи</span>
                </a>
            </li>
            ...
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="{{route('application.index')}}">
                    <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-users"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 7m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0" /><path d="M3 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /><path d="M21 21v-2a4 4 0 0 0 -3 -3.85" /></svg>
                    <span class="menu-title text-truncate" data-i18n="Email">Заявки</span>
                </a>
            </li>
            ...
            <li class=" nav-item">
                <a class="d-flex align-items-center" href="{{route('sales.index')}}">
                    ...
                    <span class="menu-title text-truncate" data-i18n="Email">Продажи</span>
                </a>
            </li>
        </ul>
    </div>
...
<footer class="footer footer-static footer-light">
    <p class="clearfix mb-0">
        <span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy; {{now()->format('Y')}}
        </span>
